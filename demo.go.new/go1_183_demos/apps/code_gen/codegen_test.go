...
const doNotEditComment = "Code generated by generator, DO NOT EDIT."

func TestCodeGenHello(t *testing.T) {
	f := jen.NewFile("main")

	f.PackageComment(doNotEditComment)
...
func TestCodeGenForProductMapping(t *testing.T) {
	...
	t.Run("generate ProductChangeSet{}", func(t *testing.T) {
	...
	t.Run("generate ProductChangeSet.toMap()", func(t *testing.T) {
