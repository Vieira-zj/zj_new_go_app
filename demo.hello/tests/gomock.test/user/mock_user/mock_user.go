...
import (
	bufio "bufio"
	bytes "bytes"
	imp1 "demo.hello/tests/gomock.test/user/imp1"
	imp2 "demo.hello/tests/gomock.test/user/imp2"
	imp3 "demo.hello/tests/gomock.test/user/imp3"
...
func (mr *MockIndexMockRecorder) Summary(buf, w interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIndexMockRecorder) Templates(a, b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIndex) ForeignFour(arg0 impfour.Imp4) {
	m.ctrl.T.Helper()
...
func (mr *MockIndexMockRecorder) Ellip(fmt interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIndexMockRecorder) Ptr(arg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIndexMockRecorder) Slice(a, b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIndexMockRecorder) Chan(a, b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIndexMockRecorder) Func(f interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIndexMockRecorder) Map(a interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIndexMockRecorder) Struct(a interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIndexMockRecorder) StructChan(a interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmbedMockRecorder) ImplicitPackage(s, t, st, pt, ct interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
